    ...
    >
      <div className="grid h-full grid-rows-[1fr_auto]">
        ...
        >
          ...
          {/* Puce gauche · sans contact droite, numéro en dessous */}
            ...
            >
              {numberGroups.map((group, i) => (
                <span
                  ...
                  style={{ fontFamily: MONO, color: CARD_GOLD }}
                >
                  {group}
                </span>
              ))}
          ...
          {/* Titulaire · Points · Membre */}
          <div className="grid grid-cols-3 items-start gap-1">
            <div className="min-w-0">
              <p
                className="text-[6px] uppercase tracking-[0.14em] opacity-55"
        ...
        {/* Pied — label + code-barres pleine largeur */}
        {showBarcode ? (
          <div className="w-full shrink-0">
            ...
            <div className={cn("w-full", compact ? "px-3 pb-2" : "px-4 pb-2.5")}>
