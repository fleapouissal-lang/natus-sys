    ...
    <div className="animate-fade-in space-y-8">
      <div>
        ...
        <p className="mt-1 text-muted">
          {isDirectorRole
            ? "Validation des retours caissiers et dépôt (périmé / cassé) — déduction du stock à la validation. Les retours dépôt sont réservés au directeur."
            : "Demandes caissiers — produits périmés ou cassés. Validez pour déduire le stock du magasin"}
