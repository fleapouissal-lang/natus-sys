-- Client Pro professionnel : nom responsable, ICE et RC
...
DROP FUNCTION IF EXISTS submit_pro_client_registration_by_store(UUID, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT);
