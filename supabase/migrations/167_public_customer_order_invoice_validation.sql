-- Portail client Pro : le détail d'achat (facture) n'est accessible qu'après validation directeur.
-- L'historique peut toujours lister les achats en attente ; seul le document facture est bloqué.
