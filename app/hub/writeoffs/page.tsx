  ...
  if (!hubStore) {
    return (
      <div className="animate-fade-in space-y-4">
        <h1 className="text-2xl font-bold tracking-tight">Retours stock dépôt</h1>
    ...
    <div className="animate-fade-in space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-muted">
          Les demandes sont validées par le directeur uniquement (déduction du stock entrepôt).
        </p>
      </div>
