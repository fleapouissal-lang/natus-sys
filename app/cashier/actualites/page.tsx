...
export default async function CashierActualitesPage() {
    ...
    <div className="animate-fade-in space-y-6">
      <div>
        ...
        <p className="mt-1 text-muted">
          Dernières informations de votre direction et de votre gérant
        </p>
      </div>
      ...
      <NewsFeed
        ...
        showAudience={false}
        emptyMessage="Aucune actualité pour vous pour le moment."
      />
    </div>
  );
}
